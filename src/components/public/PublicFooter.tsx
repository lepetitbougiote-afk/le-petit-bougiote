      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.3fr_1fr_1fr] lg:px-8">
        <div>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/75">{business.brandLine}</p>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="mt-4 space-y-3 text-sm text-white/80">
            <p>{business.address}, {business.postalCode} {business.city}</p>
            <p>{business.phonePrimary}</p>
            <p>{business.phoneSecondary}</p>
